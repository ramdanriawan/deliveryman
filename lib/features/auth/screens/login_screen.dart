...
import 'package:fashion24_deliveryman/common/basewidgets/custom_text_field_widget.dart';
...
import 'package:fashion24_deliveryman/features/auth/screens/forget_password_screen.dart';
import 'package:fashion24_deliveryman/features/auth/widgets/code_picker_widget.dart';
          ...
          child: GetBuilder<AuthController>( builder: (authController){
              return ListView( physics: const BouncingScrollPhysics(), children: [
                  ...
                  Padding(padding:  EdgeInsets.all(Dimensions.paddingSizeDefault),
                    child: Image.asset(Images.logoWithAppName, height: 50, fit: BoxFit.scaleDown, matchTextDirection: true,),),
