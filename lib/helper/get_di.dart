...
import 'package:fashion24_deliveryman/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:fashion24_deliveryman/features/auth/domain/services/auth_service.dart';
import 'package:fashion24_deliveryman/features/auth/domain/services/auth_service_interface.dart';
import 'package:fashion24_deliveryman/features/chat/controllers/chat_controller.dart';
import 'package:fashion24_deliveryman/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:fashion24_deliveryman/features/chat/domain/services/chat_service.dart';
import 'package:fashion24_deliveryman/features/chat/domain/services/chat_service_interface.dart';
import 'package:fashion24_deliveryman/features/emergency_contact/controllers/emergency_contruct_controller.dart';
import 'package:fashion24_deliveryman/features/emergency_contact/domain/repositories/emergency_contruct_repository.dart';
import 'package:fashion24_deliveryman/features/emergency_contact/domain/repositories/emergency_contruct_repository_interface.dart';
import 'package:fashion24_deliveryman/features/emergency_contact/domain/services/emergency_contruct_service.dart';
import 'package:fashion24_deliveryman/features/emergency_contact/domain/services/emergency_contruct_service_interface.dart';
import 'package:fashion24_deliveryman/features/language/controllers/language_controller.dart';
...
import 'package:fashion24_deliveryman/features/live_tracking/controllers/rider_controller.dart';
import 'package:fashion24_deliveryman/features/notification/controllers/notification_controller.dart';
import 'package:fashion24_deliveryman/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:fashion24_deliveryman/features/notification/domain/services/notification_service.dart';
import 'package:fashion24_deliveryman/features/notification/domain/services/notification_service_interface.dart';
import 'package:fashion24_deliveryman/features/onboard/controllers/onboarding_controller.dart';
import 'package:fashion24_deliveryman/features/onboard/domain/repositories/onbording_repository_interface.dart';
import 'package:fashion24_deliveryman/features/onboard/domain/services/onboard_service.dart';
...
import 'package:fashion24_deliveryman/features/order/domain/services/order_service.dart';
...
import 'package:fashion24_deliveryman/features/order_details/domain/repositories/order_details_repository.dart';
import 'package:fashion24_deliveryman/features/order_details/domain/repositories/order_details_repository_interface.dart';
import 'package:fashion24_deliveryman/features/order_details/domain/services/order_details_service.dart';
import 'package:fashion24_deliveryman/features/order_details/domain/services/order_details_service_interface.dart';
import 'package:fashion24_deliveryman/features/profile/controllers/profile_controller.dart';
import 'package:fashion24_deliveryman/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:fashion24_deliveryman/features/profile/domain/services/profile_service.dart';
import 'package:fashion24_deliveryman/features/profile/domain/services/profile_service_interface.dart';
import 'package:fashion24_deliveryman/features/review/controllers/revice_controller.dart';
import 'package:fashion24_deliveryman/features/review/domain/repositories/review_repository.dart';
import 'package:fashion24_deliveryman/features/review/domain/repositories/review_repository_interface.dart';
import 'package:fashion24_deliveryman/features/review/domain/services/review_service.dart';
...
import 'package:fashion24_deliveryman/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:fashion24_deliveryman/features/splash/domain/services/splash_service.dart';
import 'package:fashion24_deliveryman/features/splash/domain/services/splash_service_interface.dart';
import 'package:fashion24_deliveryman/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:fashion24_deliveryman/features/wallet/domain/services/wallet_service.dart';
import 'package:fashion24_deliveryman/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:fashion24_deliveryman/features/withdraw/controllers/withdraw_controller.dart';
import 'package:fashion24_deliveryman/features/withdraw/domain/repositories/withdraw_repository.dart';
import 'package:fashion24_deliveryman/features/withdraw/domain/repositories/withdraw_repository_interfaec.dart';
import 'package:fashion24_deliveryman/features/withdraw/domain/services/withdraw_service.dart';
import 'package:fashion24_deliveryman/features/withdraw/domain/services/withdraw_service_interface.dart';
...
import 'package:fashion24_deliveryman/data/repository/rider_repository.dart';
import 'package:fashion24_deliveryman/features/auth/domain/repositories/auth_repository.dart';
import 'package:fashion24_deliveryman/features/chat/domain/repositories/chat_repository.dart';
import 'package:fashion24_deliveryman/features/language/domain/repositories/language_repository.dart';
import 'package:fashion24_deliveryman/features/notification/domain/repositories/notification_repository.dart';
import 'package:fashion24_deliveryman/features/onboard/domain/repositories/onboarding_repository.dart';
import 'package:fashion24_deliveryman/features/order/domain/repositories/order_repository.dart';
import 'package:fashion24_deliveryman/features/profile/domain/repositories/profile_repository.dart';
import 'package:fashion24_deliveryman/features/splash/domain/repositories/splash_repository.dart';
import 'package:fashion24_deliveryman/features/wallet/domain/repositories/wallet_repository.dart';
